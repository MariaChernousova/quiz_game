const questions = [
    ...
    {
        'question' : 'When you enter a situation without a definite plan of action, you are said to be' +
        '"playing it by" what?',
        'content' : [
            'Fingertips',
            'Ear',
    ...
    },
    {
        ...
        'question': 'The escape velocity of a rocket fired from the earth towards the moon is' +
        'the velocity required to overcome'
    },
    {
        'correct': 3,
        'content': [
    ...
    },
    {
        ...
        'question': 'For safety, the fuse wire used in the mains for household supply of electricity must be made'+ 
        'of metal having'
    },
    {
        'correct': 3,
